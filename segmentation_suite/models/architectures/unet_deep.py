#!/usr/bin/env python3
"""
Deeper U-Net with increased receptive field (6 encoder/decoder levels).

Drop this file into the architectures folder to enable this model.
"""
...
ARCHITECTURE_ID = 'unet_deep'
ARCHITECTURE_NAME = 'UNet Deep (Large RF)'
ARCHITECTURE_DESCRIPTION = (
    "Deeper UNet with 6 encoder/decoder levels (vs 4 in standard). "
    "Goes to 1024 channels at bottleneck. Better for large structures "
...
class UNetDeep(nn.Module):
    ...
    Goes down to 1024 channels at the bottleneck with 2 extra encoder/decoder levels.
    Better for capturing larger-scale structures.
